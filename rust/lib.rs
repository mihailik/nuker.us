...
#[wasm_bindgen]
pub fn start_websocket() -> oneshot::Receiver<JsValue> {
    let (sender, receiver) = oneshot::channel();

    // Connect to an echo server
    let ws = WebSocket::new("wss://echo.websocket.events").expect("WebSocket initialized as null");
